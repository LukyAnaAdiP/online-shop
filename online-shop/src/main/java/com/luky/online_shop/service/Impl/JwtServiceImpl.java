...
public class JwtServiceImpl implements JwtService {
    ...
    public JwtServiceImpl(
            @org.springframework.beans.factory.annotation.Value("${online_shop.jwt.secret_key}") String jwtSecret,
            @org.springframework.beans.factory.annotation.Value("${online_shop.jwt.issuer}") String issuer,
            @Value("${online_shop.jwt.expirationInSecond}") long expiration
    ){
